  ...
  return (
    <div className="mx-auto max-w-4xl p-5 sm:p-10">
      ...
      <p className="pb-10 text-lg text-slate-950 sm:pb-20">
        ...
        within 6-8 days or as per the delivery date agreed at the time of order
        confirmation and delivering of the shipment subject to Courier Company /
        post office norms. Neet Bucket is not liable for any delay in delivery
        ...
        6-8 days from the date of the order and payment or as per the delivery
        ...
        any issues in utilizing our services you may contact our helpdesk on
        7890020158 or ayaan@neetbucket.com
      </p>
    </div>
  );
};
