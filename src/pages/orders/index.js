        ...
        {orders.map((item, i) => {
          ...
          return (
            <div key={i} className="flex w-full flex-col rounded-xl border">
              <div className="flex flex-col flex-wrap gap-2 border-b sm:flex-row ">
              ...
              <div>
                {order_items.map((order, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="flex flex-col items-center justify-between border-b p-3 last:border-b-0 sm:flex-row"
                    >
