  ...
  return (
    <div className="mx-auto max-w-4xl p-5 sm:p-10">
      ...
      <p className="text-lg text-slate-950">
        ...
        <br />
        <br /> Welcome to our website. If you continue to browse and use this
        ...
        govern Neet Bucket&apos;&apos;s relationship with you in relation to
        this website.
        <br />
        <br /> The term &apos;Neet Bucket&apos; or &apos;us&apos; or
        &apos;we&apos; refers to the owner of the website whose
        registered/operational office is 34 Taltala Lane Kolkata 700016 Kolkata
        WEST BENGAL 700016. The term &apos;you&apos; refers to the user or
        ...
        <br />
        <br /> Your use of any information or materials on this website is
        ...
        requirements.
        <br />
        <br /> This website contains material which is owned by or licensed to
        ...
        and conditions.
        <br />
        <br /> All trademarks reproduced in this website which are not the
        property of, or licensed to, the operator are acknowledged on the
        website.
        <br />
        <br /> Unauthorized use of this website may give rise to a claim for
        damages and/or be a criminal offense.
        <br />
        <br /> From time to time this website may also include links to other
        websites. These links are provided for your convenience to provide
        further information.
        <br />
        <br /> You may not create a link to this website from another website or
        document without Neet Bucket’s prior written consent.
        <br />
        <br /> Your use of this website and any dispute arising out of such use
        ...
        respect of any loss or damage arising directly or indirectly out of the
